...
ci_eta3 <- function(y, dims, alpha_ov_2) {
    .Call('gmwm2_ci_eta3', PACKAGE = 'gmwm2', y, dims, alpha_ov_2)
}
...
ci_eta3_robust <- function(wv_robust, wv_ci_class, alpha_ov_2, eff) {
    .Call('gmwm2_ci_eta3_robust', PACKAGE = 'gmwm2', wv_robust, wv_ci_class, alpha_ov_2, eff)
}
...
ci_wave_variance <- function(signal_modwt_bw, wv, type = "eta3", alpha_ov_2 = 0.025, robust = FALSE, eff = 0.6) {
    .Call('gmwm2_ci_wave_variance', PACKAGE = 'gmwm2', signal_modwt_bw, wv, type, alpha_ov_2, robust, eff)
}
...
wave_variance <- function(signal_modwt_bw, robust = FALSE, eff = 0.6) {
    .Call('gmwm2_wave_variance', PACKAGE = 'gmwm2', signal_modwt_bw, robust, eff)
}
...
wvar_cpp <- function(signal_modwt_bw, robust, eff, alpha, ci_type) {
    .Call('gmwm2_wvar_cpp', PACKAGE = 'gmwm2', signal_modwt_bw, robust, eff, alpha, ci_type)
}
...
modwt_wvar_cpp <- function(signal, nlevels, robust, eff, alpha, ci_type, strWavelet, decomp) {
    .Call('gmwm2_modwt_wvar_cpp', PACKAGE = 'gmwm2', signal, nlevels, robust, eff, alpha, ci_type, strWavelet, decomp)
}
...
batch_modwt_wvar_cpp <- function(signal, nlevels, robust, eff, alpha, ci_type, strWavelet, decomp) {
    .Call('gmwm2_batch_modwt_wvar_cpp', PACKAGE = 'gmwm2', signal, nlevels, robust, eff, alpha, ci_type, strWavelet, decomp)
}
...
scales_cpp <- function(nb_level) {
    .Call('gmwm2_scales_cpp', PACKAGE = 'gmwm2', nb_level)
}
