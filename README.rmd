...
```{r, fig.height = 4, fig.width = 8, fig.align = 'center', fig.cap = "Wavelet variance of two simulated processes, i.e white noise (left panel) and random waLk (right panel).", }
# Set seed for reproducibility 
set.seed(999)
