...
arma::field<arma::vec> dwt_cpp_bw(arma::vec x, std::string filter_name = "haar", 
                               unsigned int nlevels = 4, std::string boundary = "periodic", bool brickwall = true);
                                 
arma::field<arma::vec> modwt_cpp(arma::vec x, std::string filter_name = "haar", 
                                 unsigned int nlevels = 4, std::string boundary = "periodic", bool brickwall = true);

arma::field<arma::vec> modwt_test(arma::vec x, std::string filter_name = "haar", 
                                 unsigned int nlevels = 4, std::string boundary = "periodic", bool brickwall = true);

arma::field<arma::vec> modwt_cpp_bw(arma::vec x, std::string filter_name = "haar", 
                                 unsigned int nlevels = 4, std::string boundary = "periodic", bool brickwall = true);
